  ...
  "
    >
      <div className="container mx-auto flex justify-between items-center">
        ...
        {/* Links */}
        <ul
          className={`md:flex md:items-center md:space-x-8 absolute md:static w-full md:w-auto left-0 md:left-auto shadow-lg top-16 md:top-auto transition-all duration-300 ease-in bg-gradient-to-r from-purple-800 via-pink-600 to-red-600 ${
            isOpen ? "block" : "hidden"
          }`}
        >
          {["Home", "About", "Services", "Contact"].map((item) => (
            <li key={item}>
              <a
                href="#"
                className="block px-6 py-2 text-white hover:text-pink-300 hover:underline transition font-medium"
              >
                {item}
              </a>
            </li>
